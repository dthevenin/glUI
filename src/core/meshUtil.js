...
function allocateMeshVertices (resolution, c) {
...
function allocateNormalVertices (resolution, c) {
...
function allocateTriangleFaces (resolution, c) {
...
function initMeshVeticesValues (resolution, pos_x, pos_y, width, height, c) {
